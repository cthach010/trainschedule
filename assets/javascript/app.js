...
//  var frequency = $("#Frquency").val().trim();
...
// console.log (trainName + trainDestination + firstTime + frequency);

// // I'm going to put the function for the current time
...
// // the minutes until the train comes
...
// $("#trainDestination").val(sessionStorage.getItem("city"));
// $("#firstTime").val(sessionStorage.getItem("time"));
// $("#monthlyRate").val(sessionStorage.getItem("freq"));
